...
##To Do:      
##            1.  Delet Record is not fuly working
...
def search_records():
    lookup_record = search_entry.get() #gets A# from search box
...
def lookup_records():  #Top Level Searchbox Window, contains Search_records button (function)
...
def update_record():
    ...
    my_tree.item(selected, text="", values=(
        student_id_entry.get(), term_entry.get(), grad_date_entry.get(),
        first_name_entry.get(), middle_name_entry.get(), last_name_entry.get(),
        full_name_entry.get(), degree_1_entry.get(), major_1_entry.get(),
        concentration_entry.get(), honor_1_entry.get(), other_entry.get()
    ))
    ...
    update_query = """
        UPDATE graduates
        SET term = ?, grad_date = ?, first_name = ?, middle_name = ?, last_name = ?, full_name = ?,
            degree_1 = ?, major_1 = ?, concentration = ?, honor_1 = ?, other = ?
        WHERE student_id = ?
    """
    values = (
        term_entry.get(), grad_date_entry.get(), first_name_entry.get(), middle_name_entry.get(),
        last_name_entry.get(), full_name_entry.get(), degree_1_entry.get(), major_1_entry.get(),
        concentration_entry.get(), honor_1_entry.get(), other_entry.get(), student_id_entry.get()
    )
...
def generate():
    ...
    honors=honor_1_entry.get()  if honor_1_entry.get()!= "None" else ''
    gradDate = grad_date_entry.get() 
    ...
    diploma.save(f"{studentid} {fullName} {degreeType} {major1}.docx")
